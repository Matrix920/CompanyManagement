...
//        check for login
        ...
        String project_id=request.getParameter(Video.PROJECT_ID);
        if(project_id==null)
            response.sendRedirect("AdminProjects.jsp");
//        
//        String service_title=request.getParameter(Picture.);
//        if(service_title!=null && project_id!=null){
//            Service s=new Service(0, Integer.parseInt(project_id), service_title);
//            DbService.add(s);
//            
                ...
                <div class="col-lg-6 col-sm-12 offset-lg-3">
                    <div class="full">
                        <div class="contact_form_inner" action="post">
                            <fieldset>
                                <div class="field">
                                    حجم الفيديو يجب ألا يتجاوز 5 ميفا بايت
                                </div>
                                 <div class="field">
                               ...
                               <div class="field">
                                   <input type="text" name="type" value="<%=Video.VIDEO%>" readonly />
                                </div>
