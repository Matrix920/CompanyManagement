...
//        check for login
        ...
        if(search_text!=null && search_text!=null){
                if(search_type.equals(Property.ADDRESS))  {properties=DbProperty.get_properties_by_address(search_text);}
               else  if(search_type.equals(Property.PRICE)) {properties=DbProperty.get_properties_by_price(Integer.parseInt(search_text));}
                else if(search_type.equals( Property.AREA )){properties=DbProperty.get_properties_by_area(Integer.parseInt(search_text));}
                else if(search_type.equals( Property.KIND)){properties=DbProperty.get_properties_by_kind(search_text);}
                else if(search_type.equals( Property.ROOM)) {properties=DbProperty.get_properties_by_room(Integer.parseInt(search_text));}
                else properties=DbProperty.get_all_properties();
        }else{
            properties=DbProperty.get_all_properties();
        }
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
 ...
 <!-- Start Banner -->
             ...
             <div class="s003">
                 <form method="get" action="ClientProperties.jsp">
        <div class="inner-form">
          ...
          <div class="input-field second-wrap">
            <input id="search" name="search_text" type="text" placeholder="Enter Keywords?" />
          </div>
