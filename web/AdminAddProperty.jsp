...
//        check for login
        ...
        String project_id=request.getParameter(Property.PROJECT_ID);
        if(project_id==null)
                        ...
                        <div class="contact_form_inner" action="post">
                            <fieldset>
                                ...
                                <div class="field">
                                 ...
                                 <div class="field">
                                    <input type="text" name="kind" placeholder="Type" required />
                                </div>
                                
                                 <div class="field">
                                     <input type="number" name="room" placeholder="number of rooms" required />
                                </div>
