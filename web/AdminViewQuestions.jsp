...
//        check for login
   ...
   questions=DbQuestion.get_all_questions();
        %>
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
 ...
 <!-- Start Banner -->
  ...
  <tr>
      ...
      <td>
          <%= DbClient.get(q.client_id).username %>
      </td>
   
      <td>
          <a  class="btn btn-success"  href="AdminAnswerQuestion.jsp?question_id=<%=q.question_id%>">الإجابة</a>
      </td>
