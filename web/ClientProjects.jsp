...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
            ...
            <div class="col-sm-12">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link" href="ClientProperties.jsp">العقارات</a></li>
 ...
 <!-- Start Banner -->
  ...
  <tr>
      ...
      <td>
          <a  class="btn btn-success"  href="ClientProjectDetails.jsp?project_id=<%=p.project_id%>"> المزيد من التفاصيل</a>
      </td>
